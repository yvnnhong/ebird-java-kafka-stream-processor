...
-- Part 4A: Years 2020-2022 (Complete baseline distribution)
...
WITH seasonal_breeding_data_2020_to_2022 AS (
    SELECT
    ...
    WHERE 
        ...
        AND EXTRACT(YEAR FROM CAST("OBSERVATION DATE" AS DATE)) BETWEEN 2020 AND 2022
...
yearly_seasonal_counts AS (
    ...
    FROM seasonal_breeding_data_2020_to_2022
