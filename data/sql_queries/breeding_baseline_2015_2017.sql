...
-- Part 3A: Years 2015-2017 (Complete baseline distribution)
...
WITH seasonal_breeding_data_2015_to_2017 AS (
    SELECT
    ...
    WHERE 
        ...
        AND EXTRACT(YEAR FROM CAST("OBSERVATION DATE" AS DATE)) BETWEEN 2015 AND 2017
...
yearly_seasonal_counts AS (
    ...
    FROM seasonal_breeding_data_2015_to_2017
