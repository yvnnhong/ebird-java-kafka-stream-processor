...
-- Part 3B: Years 2018-2019 (Complete baseline distribution)
...
WITH seasonal_breeding_data_2018_to_2019 AS (
    SELECT
    ...
    WHERE 
        ...
        AND EXTRACT(YEAR FROM CAST("OBSERVATION DATE" AS DATE)) BETWEEN 2018 AND 2019
...
yearly_seasonal_counts AS (
    ...
    FROM seasonal_breeding_data_2018_to_2019
