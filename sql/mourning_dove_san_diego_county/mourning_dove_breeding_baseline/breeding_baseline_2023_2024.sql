...
-- Part 4B: Years 2023-2024 (Complete baseline distribution)
...
WITH seasonal_breeding_data_2023_to_2024 AS (
    SELECT
    ...
    WHERE 
        ...
        AND EXTRACT(YEAR FROM CAST("OBSERVATION DATE" AS DATE)) BETWEEN 2023 AND 2024
...
yearly_seasonal_counts AS (
    ...
    FROM seasonal_breeding_data_2023_to_2024
